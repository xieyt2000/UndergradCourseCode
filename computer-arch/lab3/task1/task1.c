...
#define ADDR_OFFSET 0x00002000
#define DEBUG_REGISTER_ADDR_CPU1   (DEBUG_REGISTER_ADDR_CPU0 + ADDR_OFFSET)
#define DEBUG_REGISTER_ADDR_CPU2   (DEBUG_REGISTER_ADDR_CPU1 + ADDR_OFFSET)
#define DEBUG_REGISTER_ADDR_CPU3   (DEBUG_REGISTER_ADDR_CPU2 + ADDR_OFFSET)
...
static void access_register_via_system_instruction(void* junk) {
    ...
    val1[2] = reg;
    asm volatile("MRS   %0, ID_AA64ISAR0_EL1" : "=r"(reg) :);
    val1[3] = reg;
