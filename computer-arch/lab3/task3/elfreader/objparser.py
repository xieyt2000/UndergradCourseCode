...
def main():
    ...
    parser.add_argument("-p", "--prefix", dest = "prefix", type = str, default = "0xaaaaaaaaa000", help = "the prefix of virtual address")
    ...
    try:
        ...
        if debug:
            ...
            print("0x%x" % (eval(prefix) + eval("0x" + init_s))) # print(prefix + init_s)
            print("0x%x" % (eval(prefix) + eval("0x" + fini_r))) # print(prefix + fini_r)
            print("0x%x" % (eval(prefix) + eval("0x" + main_s))) # print(prefix + main_s)
            print("0x%x" % (eval(prefix) + eval("0x" + main_r))) # print(prefix + main_r)
