...
parser.add_argument('--batch_norm', dest='batch_norm', action='store_true',
    help='Use batch norm in network')
...
if __name__ == '__main__':
	...
	writer = SummaryWriter(f"../tensorboard/cnn_{args.drop_rate}_{args.batch_norm}")
